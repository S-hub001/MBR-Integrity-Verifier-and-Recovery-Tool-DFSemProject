...
# ─────────────────────────────────────────────────────────────
# EXTRACT RAW PARTITION TABLE (64 BYTES)
# ─────────────────────────────────────────────────────────────

def extract_partition_table_raw(mbr_bytes: bytes) -> bytes:
    """
    Extract raw 64-byte partition table.
    """
    validate_mbr(mbr_bytes)
    return mbr_bytes[PARTITION_TABLE_OFFSET:PARTITION_TABLE_OFFSET + 64]